	...
	;; Sets up PD6 and an input and mirrors it's state on all PAs, i.e. if
	;; PD6 is high then PA0 - PA7 are high and if PD6 is low then PA0 - PA7 are
	;; low. This is done by constantly polling PD6.
